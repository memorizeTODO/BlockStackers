...
/// <summary>
/// 홀드/포켓(Pocket) 영역의 배경 및 테두리 시각화(Fill, Pattern, Border, Overlay)를
/// 실시간으로 제어하는 View 컴포넌트
/// </summary>
[ExecuteAlways]
[RequireComponent(typeof(SortingGroup))]
public class PoketView : MonoBehaviour
{
    ...
    public void AutoAssignRenderers()
    {
        ...
        {
#if UNITY_EDITOR
            if (!Application.isPlaying) Undo.RecordObject(this, "Auto Assign Poket Renderers");
#endif
